...
interface MistralAITokensToWordsClientProps {
  content: {
    title?: string;
    description?: string;
    content?: string;
...
export function MistralAITokensToWordsClient({ content }: MistralAITokensToWordsClientProps) {
    ...
    <>
      <Card className="bg-zinc-50/50 dark:bg-zinc-900/50">
        <CardHeader>
          <CardTitle className="text-3xl font-bold text-indigo-900 dark:text-indigo-100">
            {content.title || "Mistral AI Tokens to Words"}
          </CardTitle>
        </CardHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
        <div className="bg-white dark:bg-zinc-800 p-4 rounded-lg">
          ...
          <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-2">Input: Hello, Mistral AI!</p>
          <p className="text-sm text-zinc-600 dark:text-zinc-400">Output: 3 tokens, 3 words, 18 characters</p>
        </div>
        <div className="bg-white dark:bg-zinc-800 p-4 rounded-lg">
          <h4 className="text-lg font-semibold mb-2">Medium Text</h4>
          <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-2">Input: Mistral AI is a powerful language model for natural language processing.</p>
          <p className="text-sm text-zinc-600 dark:text-zinc-400">Output: 11 tokens, 11 words, 74 characters</p>
        </div>
        <div className="bg-white dark:bg-zinc-800 p-4 rounded-lg">
          <h4 className="text-lg font-semibold mb-2">Punctuation</h4>
          <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-2">Input: How does Mistral AI work? It's fascinating!</p>
          <p className="text-sm text-zinc-600 dark:text-zinc-400">Output: 7 tokens, 7 words, 42 characters</p>
        </div>
      </div>
