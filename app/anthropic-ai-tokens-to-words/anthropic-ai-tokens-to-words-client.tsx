...
interface AnthropicAITokensToWordsClientProps {
  content: {
    title?: string;
    description?: string;
    content?: string;
...
export function AnthropicAITokensToWordsClient({ content }: AnthropicAITokensToWordsClientProps) {
    ...
    <>
      <Card className="bg-zinc-50/50 dark:bg-zinc-900/50">
        <CardHeader>
          <CardTitle className="text-3xl font-bold text-indigo-900 dark:text-indigo-100">
            {content.title || "Anthropic AI Tokens to Words"}
          </CardTitle>
        </CardHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
        <div className="bg-white dark:bg-zinc-800 p-4 rounded-lg">
          ...
          <p className="text-sm text-zinc-600 dark:text-zinc-400">Output: 2 tokens, 2 words, 13 characters</p>
        </div>
        <div className="bg-white dark:bg-zinc-800 p-4 rounded-lg">
          <h4 className="text-lg font-semibold mb-2">Medium Text</h4>
          <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-2">Input: The quick brown fox jumps over the lazy dog.</p>
          <p className="text-sm text-zinc-600 dark:text-zinc-400">Output: 9 tokens, 9 words, 44 characters</p>
        </div>
        <div className="bg-white dark:bg-zinc-800 p-4 rounded-lg">
          <h4 className="text-lg font-semibold mb-2">Punctuation</h4>
          <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-2">Input: Hello, how are you? I'm doing great!</p>
          <p className="text-sm text-zinc-600 dark:text-zinc-400">Output: 7 tokens, 7 words, 38 characters</p>
        </div>
      </div>
